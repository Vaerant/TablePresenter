...
const ListBook = forwardRef(({ data, onPress, onChapterPress, isActive = false, isSelected = false, selectedIndex, setSelectedIndex, bookIndex, forceExpanded, forceCollapsed }, ref) => {
