...
const BookView = () => {
  ...
  // Scroll to target verse when it's set
  useEffect(() => {
    if (targetVerse && activeBookData && currentChapter) {
  ...
  }, [targetVerse, activeBookData, currentChapter, clearTargetVerse, setHighlightedVerse, clearHighlightedVerse]);
